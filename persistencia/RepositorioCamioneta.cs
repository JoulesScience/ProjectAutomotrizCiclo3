...
namespace persistencia
{
    public class RepositorioCamioneta: IRepositorioCamioneta
    {
        ...
        Camioneta IRepositorioCamioneta.Add(Camioneta camioneta){
            var  new_camioneta = _applicationContext.camionetas.Add(camioneta);
        ...
        Camioneta IRepositorioCamioneta.Get(int idCamioneta){
            return  _applicationContext.camionetas.FirstOrDefault(
                c => c.Id == idCamioneta);
        }
        //implementado repositorio Update, actulizar datos
        Camioneta IRepositorioCamioneta.Update(Camioneta camioneta){
